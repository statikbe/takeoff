...
(0, _jquery2.default)(function () {
    ...
    function jsDone() {
        (0, _jquery2.default)('html').addClass('js-done');
    }

    (0, _jquery2.default)(window).on('load', jsDone);
...
exports.default = function () {
    ...
    (0, _jquery2.default)(window).on('resize', (0, _debounce2.default)(windowResize, 250));
...
function windowResize() {
    ...
    var isFlyoutActive = (0, _helpers.isBreakpointActive)('flyout');

    if (!isFlyoutActive) {
        $body.removeClass('flyout-active');
    }

    _jquery2.default.assign(app.variables, {
...
exports.isBreakpointActive = isBreakpointActive;
...
function loadScript(url, cb) {
    ...
    if (typeof cb !== 'undefined') {
        (0, _jquery2.default)(script).on('load', cb);
    }
